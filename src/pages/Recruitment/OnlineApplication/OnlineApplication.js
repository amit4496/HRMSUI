      ...
      >
        ...
        <div className="row mt-4">
          <div className="col-sm-4">
            <label class="form-label">Location Job Applied:</label>
            <br />
            <input
              value={data.locationJobApplied}
              type="text"
              class="form-control"
              id="formGroupExampleInput"
              name="locationJobApplied"
              onChange={inputChangeHandler}
            />
          </div>
          ...
          <div className="row mt-4">
            <div className="col-sm-4 mt-2">
              ...
              <br />
              <input
                value={data.careerPercentage}
                type="text"
                class="form-control"
                id="formGroupExampleInput"
                name="careerPercentage"
                onChange={inputChangeHandler}
              />
            </div>
