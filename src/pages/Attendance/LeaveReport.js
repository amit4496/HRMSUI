...
useEffect(() => {
  ...
  <div className="container">
    ...
    <div className="col-sm-4 mt-2">
         <label for="cars" id='label'>Session:<span style={{ color: "red" }}> * </span></label>
       <br/>  
  ...
  <div className="col-sm-4 mt-2">
         <label for="cars" id='label'>Month:<span style={{ color: "red" }}> * </span></label>
       <br/>  
  ...
  <div className="col-sm-4 mt-2">
         <label for="cars" id='label'>Choose Emoloyee:<span style={{ color: "red" }}> * </span></label>
       <br/>  
