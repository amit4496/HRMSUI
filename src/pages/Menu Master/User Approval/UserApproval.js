...
<div className="container">
 <div className="d-flex">
  ...
  <div className="col-sm-6 mt-2">
         <label for="cars" id='label'>User Name:<span style={{ color: "red" }}> * </span></label>
       <br/>  
  ...
  <div className="col-sm-6 mt-2">
         <label for="cars" id='label'>Employee Name:<span style={{ color: "red" }}> * </span></label>
       <br/>  
  ...
  <div className="col-sm-6 mt-2">
         <label for="cars" id='label'>Approval Name:<span style={{ color: "red" }}> * </span></label>
       <br/>  
  ...
  <div className="col-sm-6 mt-2">
       <label for="cars" id='label'>Approval Code:<span style={{ color: "red" }}> * </span></label>
     <br/>
