...
import { post_training, trainingName_get } from "../../Services/service";
...
const Employee = () => {
  ...
  const handleKeytrainingdesc = (event) => {
    const { key } = event;
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const resp = await postData(data, post_training);
          ...
          <div className="row">
            <div className="col-sm-4 ">
              ...
              <input
                ...
                placeholder="Please Enter Training Name"
                onKeyPress={handleKeytraining}
              />
              {errorShow && (
                <span style={{ color: "red" }}>{errors.trainingName}</span>
              )}
            </div>
            ...
            <div className="col-sm-4">
              ...
              <input
                ...
                onKeyPress={handleKeytrainingdesc}
              />
              {errorShow && (
